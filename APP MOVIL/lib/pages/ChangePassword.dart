...
class PasswordResetDialog {
  static Future<void> show({
    ...
    String message =
        'Te mandaremos un correo con instrucciones para recuperar tu cuenta',
                    ...
                    decoration: InputDecoration(
                      ...
                      focusedBorder: OutlineInputBorder(
                        borderSide: BorderSide(
                          color:
                              Colors
                                  .lightBlueAccent, // Color del borde cuando está enfocado
                          width:
                              2.0, // poner un poco más grueso cuando está enfocado
                        ),
                      ),

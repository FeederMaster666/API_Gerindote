...
import 'package:ayuntamiento_gerindote/pages/EventosYtoDetalles.dart';
...
class _EventosAytoState extends State<EventosAyto> {
  ...
  final List<Evento> eventos = [
    Evento(
      ...
      fecha: '28 Abr, 2025',
      aforo: 3,
      imagenUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/55/Sasso_lungo_da_passo_pordoi.jpg/270px-Sasso_lungo_da_passo_pordoi.jpg',
    ),
    Evento(
      ...
      fecha: '30 Abr, 2025',
      aforo: 2,
      imagenUrl: 'https://plus.unsplash.com/premium_photo-1677347335105-1bd16607a25e?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8bmF0dXJhbGV6YSUyMHBhaXNhamV8ZW58MHx8MHx8fDA%3D',
    ),
    Evento(
      ...
      fecha: '5 May, 2025',
      aforo: 26,
      imagenUrl: 'https://www.dzoom.org.es/wp-content/uploads/2017/07/seebensee-2384369-810x540.jpg',
    ),
    Evento(
      ...
      fecha: '12 May, 2025',
      aforo: 3016,
      imagenUrl: 'https://plus.unsplash.com/premium_photo-1709579654090-3f3ca8f8416b?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8bmF0dXJhbGV6YSUyMHBhaXNhamV8ZW58MHx8MHx8fDA%3D',
    ),
    Evento(
      ...
      fecha: '15 May, 2025',
      aforo: 150,
      imagenUrl: 'https://definicion.de/wp-content/uploads/2009/12/paisaje-1.jpg',
    ),
    Evento(
      titulo: 'Club Pádel Rosario',
      ubicacion: 'Villanueva del Rosario (Málaga)',
      fecha: '15 May, 2025',
      aforo: 150,
      imagenUrl: 'https://concepto.de/wp-content/uploads/2015/03/paisaje-e1549600034372.jpg',
    ),
    Evento(
      titulo: 'Club Pádel Rosario',
      ubicacion: 'Villanueva del Rosario (Málaga)',
      fecha: '15 May, 2025',
      aforo: 150,
      imagenUrl: 'https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgeFsqiCZ9dqC9CCNb3vqhLOyWcdU0PV0UtYiVs_PuanxtUaGsDxcL-1nJdA2zTY2tztBPzup8mp4ZejXZkIs0ZioYBVYGxk8E8XLxUhmSJIKYgKWbIMutaH0uDYJfvdnpNJn_gXTyGJJ0/w1200-h630-p-k-no-nu/02273+paisajes01.jpg',
    ),
    Evento(
      titulo: 'Club Pádel Rosario',
      ubicacion: 'Villanueva del Rosario (Málaga)',
      fecha: '15 May, 2025',
      aforo: 150,
      imagenUrl: 'https://s1.significados.com/foto/paisaje-og.jpg?class=ogImageWide',
    ),
  ];
  ...
  return InkWell(
    ...
    child: Card(
      elevation: 1,
      margin: const EdgeInsets.symmetric(horizontal: 10, vertical: 5),//margen tarjeta
